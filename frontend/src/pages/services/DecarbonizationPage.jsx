...
const DecarbonizationPage = () => {
    ...
    const features = t('service_pages.decarbonization.features', { returnObjects: true });
    const valueItems = t('service_pages.decarbonization.value_items', { returnObjects: true });
        ...
        <div className="service-page">
            <section className="service-hero" style={{ background: 'linear-gradient(135deg, #1f2937 0%, #111827 100%)' }}>
                <div className="service-hero__background">
                    <AnimatedBackground variant="nature" intensity="low" />
                </div>
                <div className="container">
                    ...
                    >
                        ...
                        <h1>{t('service_pages.decarbonization.title')}</h1>
                        <p>{t('service_pages.decarbonization.hero_desc')}</p>
