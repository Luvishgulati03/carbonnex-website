...
const IntegrationsPage = () => {
    ...
    const features = t('service_pages.integrations.features', { returnObjects: true });
    const valueItems = t('service_pages.integrations.value_items', { returnObjects: true });
            ...
            <section className="service-hero" style={{ background: 'linear-gradient(135deg, #1f2937 0%, #111827 100%)' }}>
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <h1>{t('service_pages.integrations.title')}</h1>
                        <p>{t('service_pages.integrations.hero_desc')}</p>
