...
const AIValidationPage = () => {
    ...
    const features = t('service_pages.ai_validation.features', { returnObjects: true });
    const valueItems = t('service_pages.ai_validation.value_items', { returnObjects: true });
    ...
    return (
        <div className="service-page">
            <section className="service-hero">
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <h1>{t('service_pages.ai_validation.title')}</h1>
                        <p>{t('service_pages.ai_validation.hero_desc')}</p>
            ...
            <section className="service-section">
                <div className="container">
                    <h2>{t('service_pages.ai_validation.section_title')}</h2>
                    ...
                    <div className="roadmap-banner" style={{ background: '#f5f3ff', border: '1px solid #ddd6fe' }}>
