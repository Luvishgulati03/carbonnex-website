...
const BlockchainPage = () => {
    ...
    const features = t('service_pages.blockchain.features', { returnObjects: true });
    const valueItems = t('service_pages.blockchain.value_items', { returnObjects: true });
            ...
            <section className="service-hero" style={{ background: 'linear-gradient(135deg, #1f2937 0%, #111827 100%)' }}>
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <h1>{t('service_pages.blockchain.title')}</h1>
                        <p>{t('service_pages.blockchain.hero_desc')}</p>
